...
# Usage: ./install-envoy-ai-gateway.sh <ENVOY_AI_GATEWAY_VERSION> <KUBECONFIG_PATH>
...
kubectl --kubeconfig="${KUBECONFIG_PATH}" wait --timeout=2m \
...
kubectl --kubeconfig="${KUBECONFIG_PATH}" rollout restart \
